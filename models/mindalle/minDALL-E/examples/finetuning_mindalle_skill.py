...
class SkillDataModule(pl.LightningDataModule):
    def __init__(self,
                dataset_dir='/playpen3/home/jmincho/workspace/datasets/PaintSkills/',
                skill='object',
                tokenizer=None,
        ...
        train_text_data_file = dataset_dir.joinpath(f'{skill}/scenes/{skill}_train.json')
        valid_image_dir = dataset_dir.joinpath(f'{skill}/images')
        valid_text_data_file = dataset_dir.joinpath(f'{skill}/scenes/{skill}_val.json')
