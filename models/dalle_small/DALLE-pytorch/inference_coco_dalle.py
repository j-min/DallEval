...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', default='/playpen3/home/jmincho/workspace/datasets/COCO/')
    parser.add_argument('--text_file', default='object_val.json')
    # parser.add_argument('--skill_name', default='object')
    # parser.add_argument('--from_scratch', action='store_true')
    parser.add_argument('--split', type=str, default='val')
    parser.add_argument('--image_dump_dir', default='/playpen3/home/jmincho/workspace/datasets/COCO/DALLE_inference/karpathy_test')
    ...
    desc = f'{args.dalle_path}-COCO-{args.split}'
